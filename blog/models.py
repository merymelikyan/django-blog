...
class Category(models.Model):
    name = models.CharField(max_length=255, db_index=True, verbose_name = "Վերնագիր")
    slug = models.SlugField(max_length=255, unique=True, db_index=True, verbose_name = "Ցուցիչ")
